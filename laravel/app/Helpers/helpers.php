...
class Helper
{
    public static function applClasses()
    {
        ...
        $mainFooterColor = [
            //'vertical-modern-menu' => 'footer-dark gradient-45deg-cyan-light-green',
            'vertical-modern-menu' => 'footer-dark teal',
            ...
            'horizontal-menu' => 'footer-dark gradient-45deg-cyan-light-green',
        ];
