...
class DiversActsImport implements ToModel, SkipsEmptyRows, WithHeadingRow, WithValidation, SkipsOnError
{
       ...
       // var_dump($row);die();
        ...
        $diversAct = new DiverAct([
           ...
           //'NOM' => $row["nom"],
            //'PRE' => $row["prenom"],
            //'ORI'=> $row["origine"],
            //'DNAIS'=> $row["date_de_naissance"],
            //'AGE'=> $row["age"],
           // 'PRO'=> $row["profession"],
           // 'EXCON'=> $row["nom_exe"],
          //  'EXC_PRE'=> $row["prenom_exe"],
          //  'EXC_COM'=> $row["commentaire_exe"],
          //  'COM' => $row["commentaire"],
