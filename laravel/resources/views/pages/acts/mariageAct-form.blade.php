@php
    $title="Ajout Acte de mariage";
    if($mariageAct && $mariageAct->ID>0){
    $title="Modification information d'acte de mariage";
    }
@endphp
<h4>{{$title}}</h4>
@csrf
<input type="hidden" name="ID" value="{{ ($mariageAct)?$mariageAct->ID:0 }}"/>
<h6 class="mb-2 mt-2"><i class="material-icons">add_circle_outline</i> Acte de mariage</h6>
<div class="row">
    <div class="col s12">
        <div class="row">
        ...
        <div class="row">
            <div class="input-field col s6">
                ...
                <input id="CODDEP" name="CODDEP" type="text" class="validate" value="{{ ($mariageAct)?$mariageAct->CODDEP:'' }}"
                       >
                <label for="CODDEP" class="active">Code département*</label>
            </div>
            <div class="input-field col s6">
                <input id="DEPART" name="DEPART" type="text" class="validate"
                       value="{{ ($mariageAct)?$mariageAct->DEPART:'' }}" >
        ...
        <div class="row">
            <div class="input-field col s6">
                ...
                <input id="NOM" name="NOM" type="text" class="validate" value="{{ ($mariageAct)?$mariageAct->NOM:'' }}"
                       >
                <label for="NOM" class="active">Nom de l'époux*</label>
            </div>
            <div class="input-field col s6">
                <input id="PRE" name="PRE" type="text" class="validate"
                       value="{{ ($mariageAct)?$mariageAct->PRE:'' }}"  >
        ...
        <div class="input-field col s6">
                <i class="material-icons prefix">person</i>
                <input id="EXCON" name="EXCON" type="text" class="validate" value="{{ ($mariageAct)?$mariageAct->EXCON:'' }}">
                <label for="EXCON" class="active">Veuf de</label>
            </div>

            <div class="input-field col s6">
                <i class="material-icons prefix">person</i>
                <input id="COM" name="COM" type="text" class="validate" value="{{ ($mariageAct)?$mariageAct->COM:'' }}">
        ...
        <div class="row">
            <div class="input-field col s6">
                <i class="material-icons prefix">room</i>
                <input id="ORI" name="ORI" type="text" class="validate" value="{{ ($mariageAct)?$mariageAct->ORI:'' }}" >
                <label for="ORI" class="active">Origine</label>
            </div>
            <div class="input-field col s6">
                <i class="material-icons prefix">today</i>
                <input id="DNAIS" name="DNAIS" type="date" class="validate" value="{{ ($mariageAct)?$mariageAct->DNAIS:'' }}">
        ...
        <div class="row">
            <div class="input-field col s6">
                <i class="material-icons prefix">person</i>
                <input id="AGE" name="AGE" type="text" class="validate" value="{{ ($mariageAct)?$mariageAct->AGE:'' }}" >
                <label for="AGE" class="active">Age</label>
            </div>
            <div class="input-field col s6">
                <input id="PRO" name="PRO" type="text" class="validate" value="{{ ($mariageAct)?$mariageAct->PRO:'' }}">
...
<h6 class="mb-2 mt-2"><i class="material-icons"> person_add </i>&nbsp; Son père</h6>
        ...
        <div class="input-field col s6">
            <i class="material-icons prefix">contacts</i>
                <input id="P_PRO" name="P_PRO" class="materialize-textarea" value="{{ ($mariageAct)?$mariageAct->P_PRO:'' }}"/>
                <label for="P_PRO" class="active">Profession</label>
            </div>
            <div class="input-field col s6">
                <i class="material-icons prefix">comment</i>
                <input id="P_COM" name="P_COM" class="materialize-textarea" value="{{ ($mariageAct)?$mariageAct->P_COM:'' }}"/>
        ...
        <div class="input-field col s6">
            <i class="material-icons prefix">contacts</i>
                <input id="M_PRO" name="M_PRO" class="materialize-textarea" value="{{ ($mariageAct)?$mariageAct->M_PRO:'' }}"/>
                <label for="M_PRO" class="active">Profession</label>
            </div>
            <div class="input-field col s6">
                <i class="material-icons prefix">comment</i>
                <input id="M_COM" name="M_COM" class="materialize-textarea" value="{{ ($mariageAct)?$mariageAct->M_COM:'' }}"/>
        ...
        <div class="row">
            <div class="input-field col s6">
                <i class="material-icons prefix">person</i>
                <input id="C_NOM" name="C_NOM" type="text" class="validate" value="{{ ($mariageAct)?$mariageAct->C_NOM:'' }}"
                       >
                <label for="C_NOM" class="active">Nom de l'épouse*</label>
            </div>
            <div class="input-field col s6">
                <input id="C_PRE" name="C_PRE" type="text" class="validate"
                       value="{{ ($mariageAct)?$mariageAct->C_PRE:'' }}"  >
        ...
        <div class="input-field col s6">
                <i class="material-icons prefix">person</i>
                <input id="C_EXCON" name="C_EXCON" type="text" class="validate" value="{{ ($mariageAct)?$mariageAct->C_EXCON:'' }}">
                <label for="C_EXCON" class="active">Veuve de</label>
            </div>

            <div class="input-field col s6">
                <i class="material-icons prefix">person</i>
                <input id="C_X_COM" name="C_X_COM" type="text" class="validate" value="{{ ($mariageAct)?$mariageAct->C_X_COM:'' }}">
        ...
        <div class="row">
            <div class="input-field col s6">
                <i class="material-icons prefix">room</i>
                <input id="C_ORI" name="C_ORI" type="text" class="validate" value="{{ ($mariageAct)?$mariageAct->C_ORI:'' }}" >
                <label for="C_ORI" class="active">Origine</label>
            </div>
            <div class="input-field col s6">
                <i class="material-icons prefix">today</i>
                <input id="C_DNAIS" name="C_DNAIS" type="date" class="validate" value="{{ ($mariageAct)?$mariageAct->C_DNAIS:'' }}">
        ...
        <div class="row">
            <div class="input-field col s6">
                <i class="material-icons prefix">person</i>
                <input id="C_AGE" name="C_AGE" type="text" class="validate" value="{{ ($mariageAct)?$mariageAct->C_AGE:'' }}" >
                <label for="C_AGE" class="active">Age</label>
            </div>
            <div class="input-field col s6">
                <input id="C_PRO" name="C_PRO" type="text" class="validate" value="{{ ($mariageAct)?$mariageAct->C_PRO:'' }}">
        ...
        <div class="row">
            <div class="input-field col s12">
                <i class="material-icons prefix">comment</i>
                <input id="C_COM" name="C_COM" type="text" class="validate" value="{{ ($mariageAct)?$mariageAct->C_COM:'' }}" >
...
<h6 class="mb-2 mt-2"><i class="material-icons"> person_add </i>&nbsp; Son père</h6>
        ...
        <div class="input-field col s6">
            <i class="material-icons prefix">contacts</i>
                <input id="CP_PRO" name="CP_PRO" class="materialize-textarea" value="{{ ($mariageAct)?$mariageAct->CP_PRO:'' }}"/>
                <label for="CP_PRO" class="active">Profession</label>
            </div>
            <div class="input-field col s6">
                <i class="material-icons prefix">comment</i>
                <input id="CP_COM" name="CP_COM" class="materialize-textarea" value="{{ ($mariageAct)?$mariageAct->CP_COM:'' }}"/>
        ...
        <div class="input-field col s6">
            <i class="material-icons prefix">contacts</i>
                <input id="CM_PRO" name="CM_PRO" class="materialize-textarea" value="{{ ($mariageAct)?$mariageAct->CM_PRO:'' }}"/>
                <label for="CM_PRO" class="active">Profession</label>
            </div>
            <div class="input-field col s6">
                <i class="material-icons prefix">comment</i>
                <input id="CM_COM" name="CM_COM" class="materialize-textarea" value="{{ ($mariageAct)?$mariageAct->CM_COM:'' }}"/>
        ...
        <div class="row">
            <div class="input-field col s12">
                <i class="material-icons prefix">comment</i>
                <input id="T1_COM" name="T1_COM" class="materialize-textarea" value="{{ ($mariageAct)?$mariageAct->T1_COM:'' }}"/>
        ...
        <div class="row">
            <div class="input-field col s12">
                <i class="material-icons prefix">comment</i>
                <input id="T2_COM" name="T2_COM" class="materialize-textarea" value="{{ ($mariageAct)?$mariageAct->T2_COM:'' }}"/>
        ...
        <div class="row">
            <div class="input-field col s12">
                <i class="material-icons prefix">comment</i>
                <input id="T3_COM" name="T3_COM" class="materialize-textarea" value="{{ ($mariageAct)?$mariageAct->T3_COM:'' }}"/>
        ...
        <div class="row">
            <div class="input-field col s12">
                <i class="material-icons prefix">comment</i>
                <input id="T4_COM" name="T4_COM" class="materialize-textarea" value="{{ ($mariageAct)?$mariageAct->T4_COM:'' }}"/>
        ...
        <div class="row">
            ...
            <i class="material-icons prefix">perm_identity</i>
                <input id="COTE" name="COTE" class="materialize-textarea" value="{{ ($mariageAct)?$mariageAct->COTE:'' }}"/>
                <label for="COTE" class="active">Cote</label>
            </div>
            <div class="input-field col s6">
                <i class="material-icons prefix">comment</i>
                <input id="LIBRE" name="LIBRE" class="materialize-textarea" value="{{ ($mariageAct)?$mariageAct->LIBRE:'' }}"/>
        ...
        <div class="row">
            ...
            <div class="input-field col s6">
                ...
                <input id="COMGEN" name="COMGEN" class="materialize-textarea" value="{{ ($mariageAct)?$mariageAct->COMGEN:'' }}"/>
                <label for="COMGEN" class="active">Commentaire général</label>
            </div>
            <div class="input-field col s">6
                <i class="material-icons prefix">image</i>
                <input id="PHOTOS" name="PHOTOS" class="materialize-textarea" value="{{ ($mariageAct)?$mariageAct->PHOTOS:'' }}"/>
        ...
        <div class="row">
            ...
            <i class="material-icons prefix">portrait</i>
                <input id="DEPOSANT" name="DEPOSANT" class="materialize-textarea" value="{{ ($mariageAct)?$mariageAct->DEPOSANT:'' }}"/>
                <label for="DEPOSANT" class="active">Déposant</label>
            </div>
            <div class="input-field col s6">
                <i class="material-icons prefix">linked_camera</i>
                <input id="PHOTOGRA" name="PHOTOGRA" class="materialize-textarea" value="{{ ($mariageAct)?$mariageAct->PHOTOGRA:'' }}"/>
        ...
        <div class="row">
            <div class="input-field col s6">
            <i class="material-icons prefix">perm_identity</i>
                <input id="RELEVEUR" name="RELEVEUR" class="materialize-textarea" value="{{ ($mariageAct)?$mariageAct->RELEVEUR:'' }}"/>
                <label for="RELEVEUR" class="active">Releveur</label>
            </div>
            <div class="input-field col s6">
                <input id="VERIFIEU" name="VERIFIEU" class="materialize-textarea" value="{{ ($mariageAct)?$mariageAct->VERIFIEU:'' }}"/>
        ...
        <div class="input-field col s4">
                <i class="material-icons prefix">today</i>
                <input id="DTDEPOT" name="DTDEPOT" type="date" class="validate" value="{{ ($mariageAct)?$mariageAct->DTDEPOT:'' }}" >
                <label for="DTDEPOT" class="active">Date de dépot</label>
            </div>
            <div class="input-field col s4">
                <i class="material-icons prefix">today</i>
                <input id="DTMODIF" name="DTMODIF" type="date" class="validate" value="{{ ($mariageAct)?$mariageAct->DTMODIF:'' }}" >
                <label for="DTMODIF" class="active">Date de modification</label>

            </div>
            <div class="input-field col s4">
                <i class="material-icons prefix">today</i>
                <input id="LADATE" name="LADATE" type="date" class="validate" value="{{ ($mariageAct)?$mariageAct->LADATE:'' }}" >
