    ...
    <section class="error">
        ...
        <div class="error__content">
            <div class="error__message message">
                <h1 class="message__title">Page Introuvable</h1>
                <p class="message__text">Nous sommes désolés, la page que vous cherchiez n'est pas trouvée ici. Le lien que vous
                    suivi peut être cassé ou n'existe plus. Veuillez réessayer ou jeter un œil à notre.</p>
            </div>
