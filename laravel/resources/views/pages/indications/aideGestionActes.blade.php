                                        ...
                                        <div class="card-title">
                                            ...
                                            <div class="row">
                                                <div class="col s12 m6 l12">
                                                    <ul class="tabs">
                                                        <li class="tab col s3 p-0"><a class="active p-0" href="#view-FormatNem">Format NIMEGUE</a></li>
                                                        <li class="tab col s3 p-0"><a class="p-0" href="#view-FormatCSV">Format CSV</a></li>
                                                        <li class="tab col s3 p-0"><a class=" p-0" href="#view-Actes">Gérer Actes</a></li>
...
position: sticky;
top: 20px; height:300px; width:100%;"src="https://www.neuillysurseine.fr/images/neuilly/vie_quotidienne/citoyennete/justificatifs-demandes.jpg" alt="">
                                                   
                                                </div></div>
                                                <div class="card-content s60 m6 l12">
                                                    <p>Cette fonction permet de charger des actes encodés à l'aide du programme NIMEGUE (version 2 ou version 3) développé par Gilles DAVID : voir le site du logiciel et le groupe de discussion consacré au programme.</br></br> Le programme ExpoActes reconnait automatiquement la version du fichier d'export qui lui est présentée. Il faut savoir que les modifications apportée par la version 3 concernent essentiellment l'allongement de plusieurs zones, et l'ajout de champs permettant de préciser des données plus rares mais parfois rencontrées : professions des mères, nom et prénom des ex-conjoints de plusieurs intervenants, ... ainsi que, à partir de la version 3.06, liste des photographies de l'acte.</br></br>

                            Pour préparer les actes à transférer sur votre site ExpoActes, il faut exporter les données à partir de NIMEGUE en suivant les instructions suivantes :
                                Dans le panneau "Outils", presser le bouton "Export Nimègue V3" (ou V2 le cas échénat);
                            Sélectionner la commune concernée;
                            Taper un nom pour le fichier. Le plus simple pour s'y retrouver consiste à donner le nom de la commune suivi d'une lettre identifiant le type des actes qui vont être exportés (par exemple DINANT_N pour les naissances de DINANT); 
...
top: 20px; height:300px; width:100%;" alt="">
                                                ...
                                                <div class="card-content s60 m6 l12">
                                                    <p>Cette option permet de charger des actes encodés dans MS-Excel ou dans OpenOffice (Classeur) en s'adaptant de façon très souple à la structure de votre fichier.</br></br>
En général, les tableaux de dépouillements comportent en première ligne les noms des colonnes précisant le type d' information qui peut y être rangée. Par exemple, Nom, Prénom, Sexe, Nom du père, Nom de la mère, .... Ensuite dans les lignes suivantes se trouvent les informations dépouillées, un acte par ligne.</br></br>
